...
function connectComponent() {
  ...
  var setData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'setData';
  ...
  return function (ComponentOptions) {
    ...
    var _attached = lifetimes.attached || methods.attached || ComponentOptions.attached;
    var _detached = lifetimes.detached || methods.detached || ComponentOptions.detached;
    ...
    var onStateChange = function onStateChange() {
      ...
      Object.keys(newStates).forEach(function (k) {
        ...
        if (!(0, _lodash2.default)(_this2.data[k], newV)) {
          // 不相等
          hasChanged = true;
        }
      });
...
function connectPage() {
  ...
  return function (PageOptions) {
    ...
    var onStateChange = function onStateChange() {
      ...
      Object.keys(newStates).forEach(function (k) {
        var newV = newStates[k];
        if (!(0, _lodash2.default)(_this3.data[k], newV)) {
          // 不相等
          hasChanged = true;
        }
      });
...
var connector = { connectPage: connectPage, connectComponent: connectComponent, setStore: _store.setStore, getStore: _store.getStore, isEqual: _lodash2.default };
