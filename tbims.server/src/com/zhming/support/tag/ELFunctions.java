...
public class ELFunctions {
	 ...
	 * @return
	 */
	public static String getFunNm(String menuId) {
		if (MenuUtil.getFunction(menuId) != null) {
			return MenuUtil.getFunction(menuId).getMenuName();
		}
		return "--";
	}
	...
	public static String getNavigation(String function_cd) {
		if (StringUtil.isNotNull(MenuUtil.getNavigation(function_cd))) {
			return MenuUtil.getNavigation(function_cd);
		}
		return "--";
	}
}
