 ...
 */
@Entity
@Table(name = "STR_TICKET_INFO", schema = "TBIMS")
public class StrTicketInfo implements java.io.Serializable {
	...
	public StrTicketInfo() {
	}

	public StrTicketInfo(Long ticketId) {
		this.ticketId = ticketId;
	}
	public StrTicketInfo(Long ticketId, String ticketUid, String chipId, String chestId, String boxId, String batchId, String ticketTypeId, String stat, String opeUserId, Date opeTime, String saleUserId, Date saleOpeTime, String storeId, Date deliveryTime, Date signTime) {
		this.ticketId = ticketId;
