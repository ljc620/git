...
public class TeamOrderController extends BaseController {
	...
	@ControlAspect(funtionCd = "i2_sale_addorder", operType = OperType.QUERY,havPrivs=true)
	@ControllerException
	...
	public List<SysTicketType> listTicketType() {
		return teamOrderService.listTicketType();
	}
	...
	@ControlAspect(funtionCd = "添加订单", operType = OperType.ADD)
	@ControllerException
	public void addOrder(SlTeamOrder slTeamOrder, String detailStr) throws Exception {
		UserBean userBean = getLoginUserBean();
		List<SlTeamOrderDetail> detailList = JSON.parseArray(detailStr,
				SlTeamOrderDetail.class);
	...
	public List<SlChangeUser> listChangeUser(String orgId) {
		return teamOrderService.listChangeUser(orgId);
	}
	...
	@ControlAspect(funtionCd = "删除订单", operType = OperType.DELETE)
	@ControllerException
	...
	@ControlAspect(funtionCd = "更新换票人查询", operType = OperType.QUERY)
	@ControllerException
