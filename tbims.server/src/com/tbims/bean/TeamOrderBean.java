...
public class TeamOrderBean {
	 ...
	 * 入园开始时间
	 */
	private Date inDtStart;
	/**
	 * 入园结束时间
	 */
	private Date inDtEnd;
	...
	public Long getTotalExamNum() {
		return totalExamNum;
	}

	public void setTotalExamNum(Long totalExamNum) {
	...
	public Date getInDtStart() {
		return inDtStart;
	}

	public Date getInDtEnd() {
		return inDtEnd;
	}

	public void setInDtStart(Date inDtStart) {
		this.inDtStart = inDtStart;
	}

	public void setInDtEnd(Date inDtEnd) {
		this.inDtEnd = inDtEnd;
	}
