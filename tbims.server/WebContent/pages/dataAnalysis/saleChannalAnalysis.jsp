...
<script type="text/javascript" src="${path}/pages/dataAnalysis/saleChannalAnalysis.js"></script>
</head>
<body class="easyui-layout" data-options="fit:true">
		...
		<div class="ss-bar" style="margin-top:13px;">
			<div>
				<ul class="ss-ul">
					...
					<!-- 
					<li style="width: 50px; padding-left: 15px;">销售类型</li>
					<li> 
						<input id="saleTypeId" name="saleTypeId" style="width:180px;" class="easyui-combobox" />
				   	</li>
				   	 -->
					<li><a href="javascript:void(0);" onclick="saleAnalysisChart();" class="gray2-btn"
	...
	<div data-options="region:'center',border:false" style="background-color: #eee;padding:5px 15px 15px 15px;">
		<div style="height:100%;cursor: default; -ms-user-select: none; -webkit-tap-highlight-color: transparent; background-color: #fff;box-shadow: inset 0 0 0 1px rgba(0,0,0,.1);-webkit-box-shadow: inset 0 0 0 1px rgba(0,0,0,.1);">
			<div id="analySaleChart" style="width: 100%; height: 100%;;"></div>

		</div>
		<div style="float:bottom;margin-top:-20px;margin-left:10px;color:red;text-align:left;">(点击饼块或图例，可筛选查看)</div>
	</div>
</body>
</html>