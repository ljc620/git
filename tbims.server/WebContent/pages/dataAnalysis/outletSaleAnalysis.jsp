...
<script type="text/javascript" src="${path}/pages/dataAnalysis/outletSaleAnalysis.js"></script>
</head>
		...
		<div class="ss-bar" style="margin-top:13px;">
			<div>
				<ul class="ss-ul">
					...
					<li style="width: 50px; padding-left: 15px;">统计分类</li>
					<li>
						<input id="groupType" name="groupType" style="width:180px;" class="easyui-combobox" />
				   	</li>
					<li><a href="javascript:void(0);" onclick="outletSaleChart();" class="gray2-btn"
