...
<script type="text/javascript" src="${path}/pages/dataAnalysis/admissionAnalysis.js"></script>
</head>
<body class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center',border:false" style="background-color: #eee;padding:5px 15px 15px 15px;">
		...
		<div style="float:bottom;margin-top:-20px;margin-left:10px;color:red;text-align:left;font-weight:bold;">(点击饼块或图例，可筛选查看)</div>
	</div>
</body>
</html>