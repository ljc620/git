...
<script type="text/javascript" src="${path}/pages/delivery/useLessTicketConfirm.js"></script>
 	...
 	<div id="mytable-buttons">
		...
		<div class="ss-bar">
			<ul class="ss-ul">
				...
				<li>
					<input id="startDate" name="startDate" class="easyui-datebox" style="width:180px;" value="true"></input>
					--<input id="endDate" name="endDate" class="easyui-datebox" style="width:180px;" value="true" validType="checkDt['#startDate']"></input>
				</li> -->
		...
		<div class="ss-bar2">
			<ul class="ss-ul">
				<li>
					<a href="javascript:void(0)" class="red-btn icon-add" onclick="javascript:confirm();">
						<span class="btn-text">确认</span>
					</a>
					 <span style="padding-left:300px;font-weight:700;"> 合计:</span><span id="totalNum" style="padding-left:3px;"></span>
				</li>
 			</ul>
		</div>
	</div>
