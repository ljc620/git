...
$(function() {
	var uselessTime='${param.uselessTime}';
	var outletId='${param.outletId}';
	var ticketTypeId='${param.ticketTypeId}';
	var stat='${param.stat}';
	$myTable = $('#detailtable');
	createTable(uselessTime,outletId,ticketTypeId,stat);
});

function createTable(uselessTime,outletId,ticketTypeId,stat) {
	$myTable.datagrid({
