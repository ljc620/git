		...
		<form id="fm" method="post" class="bf-from">
			<table class="form-table" style="width: 680px;">
				<tr>
					...
					<td>
						<input name="userId" class="easyui-textbox" required="true" value="${sysUser.userId}" data-options="validType:['chineseCheck']"></input>
				...
				<tr>
					...
					<td>
						<input name="cardId" class="easyui-numberbox" value="${sysUser.cardId}"></input>
					</td>
				</tr>
				<tr>
