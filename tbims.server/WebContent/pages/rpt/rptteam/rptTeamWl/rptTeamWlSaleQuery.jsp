...
<script type="text/javascript" src="rptTeamWlSaleQuery.js"></script>
</head>
<body>
		...
		<div class="ss-bar">
			<form id="form">
				<ul class="ss-ul">
					...
					<li>
						<input id="opeTime" name="opeTime" class="easyui-datebox"  data-options="editable:false"  style="width:100px;" value="true" />-
						<input id="opeTime2" name="opeTime2" class="easyui-datebox"  data-options="editable:false"  style="width:100px;" value="true" /> 
					</li>
					<li  style="width: 50px;padding-left:8px;">票种名称</li>
					<li>
						<input id="ticketTypeId" name="ticketTypeId" class="easyui-combobox" style="width:140px;"></input>
					</li>
					...
					<li><span class="col"><a class="indigo-btn" style="margin-left:2px;" id="btnExcel" onclick="expExcel()">导出EXCEL</a></span></li>
				</ul>
			</form>
		</div>
	</div>
