$(function() {
	...
	createWlRefundTable(queryParams);
});
function createWlRefundTable(params) {
	$myTable.datagrid({
		nowrap : true,// 是否只显示一行，即文本过多是否省略部分。
		striped : true,
		url : $ctx + '/rptsale/wlRefundDetail.do', // controller地址
		onLoadSuccess : function(e) {
		},
		onLoadError : function(e) {
			getAjaxError(e);
...
function expExcel() {
	...
	var url = $ctx + '/rptsale/expExlWlRefundDetail.do';
