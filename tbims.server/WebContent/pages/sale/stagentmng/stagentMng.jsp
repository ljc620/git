...
<script type="text/javascript" src="stagentMng.js"></script>
...
<body>
			...
			<c:if test="${myel:hasPriv('i2_sale_org_add',userSession.functionSet)}">
				<li>
					<a href="javascript:void(0)" class="red-btn icon-add" onclick="javascript:addOrg();">
						<span class="btn-text">新增实体代理商</span>
					</a>
				</li>
				<li>
	...
	<div id="orgDialog" class="easyui-dialog" style="width: 600px; height: 350px; padding: 5px 10px" modal="true" closed="true" buttons="#dlg-buttons">
	</div>
