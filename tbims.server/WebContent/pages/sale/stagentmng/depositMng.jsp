...
<script type="text/javascript" src="${path}/pages/sale/stagentmng/depositMng.js"></script>
...
<body>
	...
	<div id="dlg-buttons" style="text-align: center; display: none;">
		<a href="javascript:void(0)" id="save-buttons" class="blue-btn" onclick="javascript:saveDeposit()" style="width: 90px;margin-right: 10px;margin-left:10px;">保存</a>
