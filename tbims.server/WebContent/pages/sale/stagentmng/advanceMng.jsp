...
<script type="text/javascript"
	src="${path}/pages/sale/stagentmng/advanceMng.js"></script>
...
<body>
	<div id="mytable-buttons">
		<div class="ss-bar">
			<ul class="ss-ul">
				...
				<li>${slOrg.orgId} <input type="hidden" id="orgId" name="orgId"
					value="${slOrg.orgId}">
				</li>
		...
		<div class="ss-bar2">
			<ul class="ss-ul">
				<c:if
					test="${myel:hasPriv('i2_sale_org_add',userSession.functionSet)}">
					<li><a href="javascript:void(0)" class="red-btn icon-add"
						onclick="javascript:addAdvance('${slOrg.orgId}');"> <span
							class="btn-text">新增预付款</span>
					</a></li>
				</c:if>
			</ul>
		</div>
	...
	<div id="addDialog" class="easyui-dialog"
		style="width: 600px; height: 350px; padding: 5px 10px" modal="true"
