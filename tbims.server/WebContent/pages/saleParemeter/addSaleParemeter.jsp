	...
	<div> 
		<form id="fm" method="post" class="bf-from">
			<table class="form-table" style="width: 90%;">
			     <tr>
					<td class="label" style="width:150px;">参数代码</td>
					<td colspan="3">
			    ...
			    <tr>
					...
					<td colspan="3">
						<input name="paremeterName" id="paremeterName" class="easyui-textbox" validType="length[1,100]"  style="width:220px;" required="true"></input>	
						<span class="starStyle">*</span>
					</td>
				</tr>
				<tr>
