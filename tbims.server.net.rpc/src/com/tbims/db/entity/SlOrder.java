...
public class SlOrder implements java.io.Serializable {
	...
	public SlOrder(String orderId, String orderType, Long ticketCount, Long dueSum, Long realSum, String remark, String payStat, String saleUserId, Date saleTime, Date versionNo) {
		this.orderId = orderId;
