...
// Generated 2017-6-28 19:28:36 by Hibernate Tools 4.0.0
...
public class SysClient implements java.io.Serializable {
	 ...
	 */
	private Integer gateMode;

	/** 
	 * 运行状态(01-正常,02-停用,04-闸机异常,05-员工卡读卡器异常,06-票据读卡器异常,07-IO输出异常)
	 */
	private Integer runStat;
	...
	public SysClient(Long clientId, String clientName, String clientType, Long regionId, Long outletId, String ipAddr, String port, String stat, Integer gateMode, Integer runStat, Date reportTime, String token, String opeUserId, Date opeTime) {
		this.clientId = clientId;
	...
	public Integer getGateMode() {
		return this.gateMode;
	}
	/** 
	 * 运行模式0-正常模式,1-紧急模式,2-落杆模式,3-关闭模式,4-A向关闭,B向不控制,5-A向不控制,B向关闭.
	 */
	public void setGateMode(Integer gateMode) {
		this.gateMode = gateMode;
	}
	 ...
	 * 运行状态(01-正常,02-停用,04-闸机异常,05-员工卡读卡器异常,06-票据读卡器异常,07-IO输出异常).
	 */
	@Column(name = "RUN_STAT", length = 2,columnDefinition="int default 0")
	public Integer getRunStat() {
		return this.runStat;
	}
	/** 
	 * 运行状态(01-正常,02-停用,04-闸机异常,05-员工卡读卡器异常,06-票据读卡器异常,07-IO输出异常).
