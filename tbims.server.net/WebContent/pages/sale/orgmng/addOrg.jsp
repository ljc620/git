		...
		<input type="hidden" name="orgType" id="orgType" value="0">
			<table class="form-table" style="width: 90%;">
			    <tr>
					...
					<td colspan="3">
						<input name="orgId" id="orgId" class="easyui-textbox" validType="length[2,20]"  style="width:200px;" required="true"></input>
				...
				<tr>
					...
					<td colspan="3">
						<input name="tel" id="tel" class="easyui-textbox" validType="length[1,15]" style="width:200px;"></input>
					</td>
				</tr>
			</table>
		</form>
