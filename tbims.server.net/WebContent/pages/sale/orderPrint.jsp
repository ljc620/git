...
<body style="text-align: center">
	...
	<div class="ss-bar" style="padding: 2px;">
		<a href="javascript:void(0)" class="blue-btn"
			onclick="javascript:printInfo()"
			style="width: 40px; padding-left: 5px">打印</a>
	</div>
	<div id="noprintContent">
		<!-- 签约社 -->
		<div style="width: 649px; height: 350px; margin: 0 auto;">
			<table class="report-table" style="width: 640px;">
				<tr>
					<td colspan="6"
						style="width: 600px; font-size: 14px; font-weight: bold"
						align="center">团队换票单</td>
				</tr>
				<tr>
					<td colspan="5" style="width: 540px; font-weight: bold"
						align="center">基本信息</td>
					<td rowspan="4" align="center"
						style="border-bottom: 2px dashed black;">旅行社盖章处</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="5" style="width: 540px; font-weight: bold"
						align="center">入园信息</td>
					<td rowspan="${fn:length(slTeamOrder.slTeamOrderDetails)+3}"
						style="border-top: 0;" align="center">签约社留存</td>
				</tr>
				<tr>
					<td align="center" style="width: 120px;">入园日期</td>
					<td><fmt:formatDate value="${slTeamOrder.inDt}" type="both"
			...
			<table style="font-size: 11px; margin-top: 5px; width: 100%">
				...
				<tr>
					<td colspan="3"
						style="height: 20px; border-bottom: 1px dashed black;">
					<td>
				</tr>
			</table>
		</div>
		...
		<div style="width: 649px; height: 350px; margin: 30px auto;">
			<table class="report-table" style="width: 640px;">
				...
				<tr>
					<td colspan="5" style="width: 540px; font-weight: bold"
						align="center">入园信息</td>
					<td rowspan="${fn:length(slTeamOrder.slTeamOrderDetails)+3}"
						style="border-top: 0;" align="center">换票网点留存</td>
				</tr>
				<tr>
					<td align="center" style="width: 120px;">入园日期</td>
					<td><fmt:formatDate value="${slTeamOrder.inDt}" type="both"
			...
			<table
				style="font-size: 11px; padding: 2px; margin-top: 5px; width: 100%">
				<tr>
					<td>旅行社经办人签名（盖章）：</td>
					<td style="width: 280px;">操作人员签名（盖章）：</td>
					<td style="width: 120px;">日期：</td>
		...
		<!-- 票务中心 -->
		<div
			style="width: 649px; height: 326px; padding: 2px; margin: 0 auto;">
			<table class="report-table" style="width: 640px;">
				<tr>
					<td colspan="6"
						style="width: 600px; font-size: 14px; font-weight: bold"
				...
				<tr>
					<td colspan="5" style="width: 540px; font-weight: bold"
						align="center">入园信息</td>
					<td rowspan="${fn:length(slTeamOrder.slTeamOrderDetails)+3}"
						style="border-top: 0;" align="center">票务中心留存</td>
				</tr>
				<tr>
					<td align="center" style="width: 120px;">入园日期</td>
					<td><fmt:formatDate value="${slTeamOrder.inDt}" type="both"
