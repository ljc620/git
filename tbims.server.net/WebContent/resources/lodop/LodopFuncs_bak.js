...
**************************/
    ...
    var hrefpath=rootpath+"/res/lodop/install_lodop.exe";
        var strHtml1="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"+hrefpath+"'>执行安装</a>,安装后请关闭浏览器重新打开并允许运行Activex控件。</font>";
        var strHtml2="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"+hrefpath+"'>执行升级</a>,升级后请重新进入。</font>";
