...
public class SysDictionary implements java.io.Serializable {
	...
	public SysDictionary(String dictionaryId, String keyCd, String keyName, String itemCd, String itemName, String itemVal, String stat, Short orderNum, Date versionNo) {
		this.dictionaryId = dictionaryId;
		this.keyCd = keyCd;
