...
public class SysGenId implements java.io.Serializable {
	...
	public SysGenId(String seqRule, BigDecimal seqVal, String remark, Short seqSetting) {
		this.seqRule = seqRule;
		this.seqVal = seqVal;
		this.remark = remark;
	...
	public Short getSeqSetting() {
		return this.seqSetting;
	}

	public void setSeqSetting(Short seqSetting) {
		this.seqSetting = seqSetting;
	}
