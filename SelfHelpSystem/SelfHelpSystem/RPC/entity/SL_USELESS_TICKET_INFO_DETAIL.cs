...
namespace tbims.rpc.entity
{
  ...
  [Serializable]
  #endif
  public partial class SL_USELESS_TICKET_INFO_DETAIL : TBase
  {
    ...
    public SL_USELESS_TICKET_INFO_DETAIL() {
    }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("SL_USELESS_TICKET_INFO_DETAIL");
        ...
        if (__isset.uselessUserId) {
          field.Name = "uselessUserId";
          field.Type = TType.I64;
          field.ID = 7;
          oprot.WriteFieldBegin(field);
          oprot.WriteI64(UselessUserId);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("SL_USELESS_TICKET_INFO_DETAIL(");
      bool __first = true;
      if (__isset.uselessTime) {
