...
namespace tbims.rpc.entity
{
  ...
  [Serializable]
  #endif
  public partial class RPT_SALE_DATA_OUTLET : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("RPT_SALE_DATA_OUTLET");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("RPT_SALE_DATA_OUTLET(");
      bool __first = true;
      if (__isset.rtpDate) {
