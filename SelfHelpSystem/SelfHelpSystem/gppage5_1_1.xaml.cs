...
{
    public partial class GPPage5_1_1 : Page, IComponentConnector
	{
		private MainWindow parent;

		private SpeechSynthesizer ss = new SpeechSynthesizer();

		public GPPage5_1_1(MainWindow parentWindow)
		{
		...
		private void Page_Loaded(object sender, RoutedEventArgs e)
		{
			...
			//this.ss.SpeakAsync(ConfigHelper.GetConfigValue("speechqp", "paybankpass"));
			//this.web.Source = new Uri(AppDomain.CurrentDomain.BaseDirectory + "flash\\f2.swf");
		}
        ...
        //        Uri resourceLocator = new Uri("/SelfHelpSystem;component/gpoperationpage/gppage5_1_1.xaml", UriKind.Relative);
        ...
        //    {
        //    case 1:
        //        ((GPPage5_1_1)target).Loaded += new RoutedEventHandler(this.Page_Loaded);
        //        ((GPPage5_1_1)target).Unloaded += new RoutedEventHandler(this.Page_Unloaded);
        //        break;
        //    case 2:
