...
{
    public partial class GPPage5_3 : Page, IComponentConnector
	{
        private ILog _log = LogManager.GetLogger("SelfHelpSystem.Client");
		private DispatcherTimer counttimer;
        private DispatcherTimer timer_test;//委托用
        private bool isre = false;//委托用
        private bool istest = false;//委托用
		...
		public GPPage5_3(MainWindow parentWindow)
		{
        ...
        private void Timer_test(object sender, EventArgs e)
        {
            if (isre)
            {
                this.Dispatcher.BeginInvoke((Action)delegate()
                {
                    ...
                    this.txt_show.Text = "购票信息-支付宝支付失败！";
                    istest = true;
                });
                if (istest)
                {
                  ...
                  //  this.parent.EndOperation();
                    this.parent.Err_Info = "支付宝支付失败！请重试或至人工窗口购票。";
        ...
        //        Uri resourceLocator = new Uri("/SelfHelpSystem;component/gpoperationpage/gppage5_3.xaml", UriKind.Relative);
        ...
        //    {
        //    case 1:
        //        ((GPPage5_3)target).Loaded += new RoutedEventHandler(this.Page_Loaded);
        //        ((GPPage5_3)target).Unloaded += new RoutedEventHandler(this.Page_Unloaded);
        //        break;
        //    case 2:
