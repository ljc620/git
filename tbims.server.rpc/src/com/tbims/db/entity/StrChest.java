 ...
 */
@Entity
@Table(name = "STR_CHEST", schema = "TBIMS")
public class StrChest implements java.io.Serializable {
	...
	public StrChest(String chestId) {
		this.chestId = chestId;
	}
	public StrChest(String chestId, String batchId, String ticketTypeId, String stat, String boxNum, Long ticketNum, Long beginNo, Long endNo, String opeUserId, Date opeTime) {
		this.chestId = chestId;
