 ...
 * 属性文件管理工具类
 */
public class PropertyManagerjson {

    private static PropertyManagerjson manager = null;
     ...
     */
    public static PropertyManagerjson getInstance() {
        if (manager == null) {
            synchronized(managerLock) {
                if (manager == null) {
                    manager = new PropertyManagerjson(propsName);
                }
            }
        }
        return manager;
   ...
   public static void savePropsToFile(Properties properties) {
        ...
        try {
        	String filename = PropertyManagerjson.class.getResource("/").getPath();
     ...
     * 创建新的属性管理器
     */
    private PropertyManagerjson(String resourceURI) {
    ...
    private void saveProps() {
        ...
        String path=PropertyManagerjson.class.getResource(this.propsName).getPath();
